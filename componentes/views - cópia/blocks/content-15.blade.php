<section class="w-full py-12 bg-white sm:py-20 tails-selected-element" x-data="{ page: 1, total_pages: 3 }" data-tails-scripts="//unpkg.com/alpinejs" contenteditable="true">
  <div class="flex flex-col items-center justify-center mx-auto xl:flex-row max-w-7xl">
      ...
      <div class="box-content relative flex items-center w-full h-auto max-w-2xl py-5 mx-auto overflow-hidden xl:w-3/5 rounded-xl bg-gradient-to-r from-transparent via-transparent to-gray-100">
          ...
          <!-- Slide Page 1 -->
          <div class="flex px-6 space-x-6 transition duration-500 ease-out transform xl:pl-6 h-94 relative" :class="{ '-translate-x-full pr-10' : page > 1, 'relative': page == 1, 'absolute': page != 1 }">

              <!-- story 1 -->
              <div class="flex flex-col flex-shrink-0 w-1/2 overflow-hidden rounded-lg shadow-lg" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                  ...
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white">
                      <div class="flex-1">
                          <p class="inline-block py-1 pl-10 pr-4 mb-2 -ml-10 text-xs font-medium leading-5 text-white transform -translate-y-2 bg-indigo-600 rounded" data-primary="indigo-600" data-rounded="rounded">
          ...
          <!-- Slide Page 2 -->
          <div class="flex space-x-6 transition duration-500 ease-out transform h-94 translate-x-full absolute" :class="{ '-translate-x-full pr-10' : page > 2, 'translate-x-full' : page < 2, 'translate-x-0 ml-5' : page == 2, 'relative': page == 2, 'absolute': page != 2 }">
          ...
          <!-- Slide Page 3 -->
          <div class="flex space-x-6 transition duration-500 ease-out transform h-94 translate-x-full absolute" :class="{ 'translate-x-full' : page < 3, 'translate-x-0 ml-5' : page == 3, 'relative': page == 3, 'absolute': page != 3 }">
