<section class="w-full py-16 bg-white tails-selected-element" contenteditable="true">
          ...
          <div class="relative col-span-12 duration-150 ease-out transform border-2 border-black cursor-pointer md:col-span-6 lg:col-span-4 hover:scale-105">
              ...
              <div class="p-5 pb-6">
                  ...
                  <p class="text-gray-700">
                      <span class="">Follow these simple steps to learn how you can increase your gains and get the most out of your training days. In this post we'll show you exactly how to accomplish this.</span>
                  </p>
              </div>
          </div>
