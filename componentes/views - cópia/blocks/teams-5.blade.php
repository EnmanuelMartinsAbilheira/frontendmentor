<section class="relative w-full bg-white tails-selected-element" contenteditable="true">
  <div class="absolute inset-0 w-full h-full opacity-25 sm:opacity-50">
      ...
      <svg class="absolute top-0 left-0 w-auto h-full opacity-30" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path id="path-1" d="M0 0h50v50H0z"></path><path id="path-3" d="M0 0h50v50H0z"></path></defs><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="magic-pattern-geometric-1626300387433" transform="matrix(-1 0 0 1 150 0)"><g id="Group" transform="translate(0 25)" fill="#93FFFD" fill-rule="nonzero"><path d="M25 0C11.193 0 0 11.193 0 25h50C50 11.193 38.807 0 25 0z" id="Path"></path></g><path d="M25 50C11.193 50 0 38.807 0 25S11.193 0 25 0h25v50H25z" transform="translate(100)" id="Path" fill="#DEB9FF"></path><g id="Clipped" transform="translate(0 100)"><mask id="mask-2" fill="#fff"><use xlink:href="#path-1"></use></mask><path d="M25 50C11.193 50 0 38.807 0 25S11.193 0 25 0h25v50H25z" id="Path" fill="#B3EBFF" mask="url(#mask-2)"></path></g><g id="Clipped" transform="translate(100 200)"><mask id="mask-4" fill="#fff"><use xlink:href="#path-3"></use></mask><path d="M25 50C11.193 50 0 38.807 0 25S11.193 0 25 0h25v50H25z" id="Path" fill="#93FFFD" mask="url(#mask-4)"></path></g></g></g></svg>
  </div>
