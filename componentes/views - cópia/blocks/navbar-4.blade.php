<section class="w-full px-8 text-gray-700 bg-white body-font tails-selected-element" contenteditable="true">
  <div class="container flex flex-col flex-wrap items-center py-5 mx-auto max-w-7xl md:flex-row">
      ...
      <a href="#_" class="flex items-center order-first mb-6 font-medium text-gray-900 md:order-none md:w-1/5 title-font md:items-center md:justify-center md:mb-0">
          <span class="text-xl font-black leading-none text-gray-900 select-none logo">tails<span class="text-indigo-600" data-primary="indigo-600">.</span></span>
      </a>
